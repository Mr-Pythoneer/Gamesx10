...
// ---------------------------------------------------------------- i18n (es/fr/ja/ko)
// Every English string passed as T()'s first argument, plus every WEAPONS/PASSIVES/
// ENEMIES/EVOLUTIONS/CHARACTERS name/desc from content.js, mapped to es/fr/ja/ko.
// T()'s own (en, zh) argument pair is untouched — this only extends the other four.
registerTranslations({
  // --- UI chrome ---
  'level': { es: 'nivel', fr: 'niveau', ja: 'レベル', ko: '레벨' },
  'kills': { es: 'bajas', fr: 'éliminations', ja: '撃破数', ko: '처치수' },
  'time left': { es: 'tiempo restante', fr: 'temps restant', ja: '残り時間', ko: '남은 시간' },
  'final wave': { es: 'oleada final', fr: 'vague finale', ja: '最終ウェーブ', ko: '최종 웨이브' },
  'BOSS': { es: 'JEFE', fr: 'BOSS', ja: 'ボス', ko: '보스' },
  'gold': { es: 'oro', fr: 'or', ja: 'ゴールド', ko: '골드' },
  'HULL': { es: 'CASCO', fr: 'COQUE', ja: '船体', ko: '선체' },
  'EVOLUTION': { es: 'EVOLUCIÓN', fr: 'ÉVOLUTION', ja: '進化', ko: '진화' },
  'WEAPON': { es: 'ARMA', fr: 'ARME', ja: '武器', ko: '무기' },
  'PASSIVE': { es: 'PASIVA', fr: 'PASSIF', ja: 'パッシブ', ko: '패시브' },
  'GOLD': { es: 'ORO', fr: 'OR', ja: 'ゴールド', ko: '골드' },
  ' (new)': { es: ' (nuevo)', fr: ' (nouveau)', ja: '(新規)', ko: ' (신규)' },
  ' +1': { es: ' +1', fr: ' +1', ja: ' +1', ko: ' +1' },
  'Gold Cache': { es: 'Alijo de Oro', fr: "Cache d'Or", ja: 'ゴールドの隠し場所', ko: '골드 상자' },
  '+20 gold, banked at run end.': {
    es: '+20 de oro, se acredita al final de la partida.',
    fr: '+20 or, crédité à la fin de la partie.',
    ja: '+20ゴールド、ラン終了時に加算。',
    ko: '+20 골드, 런 종료 시 지급.',
  },
  'LEVEL UP': { es: 'SUBIDA DE NIVEL', fr: 'NIVEAU SUPÉRIEUR', ja: 'レベルアップ', ko: '레벨 업' },
  'PRESS 1 / 2 / 3  ·  OR CLICK A CARD': {
    es: 'PULSA 1 / 2 / 3  ·  O HAZ CLIC EN UNA CARTA',
    fr: 'APPUYEZ SUR 1 / 2 / 3  ·  OU CLIQUEZ UNE CARTE',
    ja: '1 / 2 / 3 キーを押す · またはカードをクリック',
    ko: '1 / 2 / 3 키를 누르거나 · 카드를 클릭하세요',
  },
  'RUN COMPLETE': { es: 'PARTIDA COMPLETADA', fr: 'PARTIE TERMINÉE', ja: 'ラン完了', ko: '런 완료' },
  'OVERWHELMED': { es: 'DESBORDADO', fr: 'SUBMERGÉ', ja: '制圧された', ko: '압도당함' },
  'The Swarm Mother is down.': {
    es: 'La Madre del Enjambre ha caído.',
    fr: "La Mère de l'Essaim est vaincue.",
    ja: 'スウォームマザーを撃破した。',
    ko: '스웜 마더가 쓰러졌다.',
  },
  'The swarm closed in.': {
    es: 'El enjambre te alcanzó.',
    fr: "L'essaim vous a submergé.",
    ja: '群れに飲み込まれた。',
    ko: '무리가 포위해왔다.',
  },
  'ENTER / SPACE — RETURN TO TITLE': {
    es: 'ENTER / ESPACIO — VOLVER AL TÍTULO',
    fr: 'ENTRÉE / ESPACE — RETOUR AU TITRE',
    ja: 'エンター / スペース — タイトルに戻る',
    ko: '엔터 / 스페이스 — 타이틀로 돌아가기',
  },
  'wins': { es: 'victorias', fr: 'victoires', ja: '勝利数', ko: '승리' },
  'best kills': { es: 'mejor racha', fr: 'meilleur score', ja: '最高撃破数', ko: '최다 처치' },
  'SWARM': { es: 'ENJAMBRE', fr: 'ESSAIM', ja: 'スウォーム', ko: '스웜' },
  'YOU ONLY MOVE. EVERYTHING ELSE FIRES ITSELF.': {
    es: 'SOLO TE MUEVES. TODO LO DEMÁS DISPARA SOLO.',
    fr: 'VOUS NE FAITES QUE BOUGER. LE RESTE TIRE TOUT SEUL.',
    ja: '移動するだけでいい。あとは全て自動で発射される。',
    ko: '당신은 움직이기만 하면 됩니다. 나머지는 알아서 발사됩니다.',
  },
  'campaign': { es: 'campaña', fr: 'campagne', ja: 'キャンペーン', ko: '캠페인' },
  'operative': { es: 'operativo', fr: 'agent', ja: '操縦者', ko: '요원' },
  'PRESS SPACE TO DEPLOY': {
    es: 'PULSA ESPACIO PARA DESPLEGAR',
    fr: 'APPUYEZ SUR ESPACE POUR VOUS DÉPLOYER',
    ja: 'スペースキーで出撃',
    ko: '스페이스 키로 출격',
  },
  'LOCKED — CHOOSE ANOTHER OPERATIVE': {
    es: 'BLOQUEADO — ELIGE OTRO OPERATIVO',
    fr: 'VERROUILLÉ — CHOISISSEZ UN AUTRE AGENT',
    ja: 'ロック中 — 他の操縦者を選択',
    ko: '잠김 — 다른 요원을 선택하세요',
  },
  'armory': { es: 'armería', fr: 'armurerie', ja: '兵装庫', ko: '무기고' },
  'damage': { es: 'daño', fr: 'dégâts', ja: 'ダメージ', ko: '피해량' },
  'speed': { es: 'velocidad', fr: 'vitesse', ja: '速度', ko: '속도' },
  'max hull': { es: 'casco máx.', fr: 'coque max.', ja: '最大船体', ko: '최대 선체' },
  'WASD / ARROWS TO MOVE  ·  OR HOLD THE POINTER TO STEER  ·  1 2 3 TO DRAFT': {
    es: 'WASD / FLECHAS PARA MOVERTE  ·  O MANTÉN EL PUNTERO PARA DIRIGIR  ·  1 2 3 PARA ELEGIR',
    fr: 'WASD / FLÈCHES POUR VOUS DÉPLACER  ·  OU MAINTENEZ LE POINTEUR POUR DIRIGER  ·  1 2 3 POUR CHOISIR',
    ja: 'WASD / 矢印キーで移動 · またはポインターを押し続けて操縦 · 1 2 3 でドラフト選択',
    ko: 'WASD / 방향키로 이동 · 또는 포인터를 눌러 조종 · 1 2 3 으로 드래프트 선택',
  },

  // --- weapons (content.js WEAPONS) ---
  'Whirling Blade': { es: 'Cuchilla Giratoria', fr: 'Lame Tournoyante', ja: '回転ブレード', ko: '선풍의 칼날' },
  'Spinning blades orbit you, cutting anything they touch.': {
    es: 'Hojas giratorias orbitan a tu alrededor, cortando todo lo que tocan.',
    fr: 'Des lames tournoyantes vous entourent, tranchant tout ce qu\'elles touchent.',
    ja: '刃が周囲を旋回し、触れたものを切り裂く。',
    ko: '회전하는 칼날이 주위를 돌며 닿는 모든 것을 벤다.',
  },
  'Auto Bolt': { es: 'Perno Automático', fr: 'Carreau Automatique', ja: 'オートボルト', ko: '오토 볼트' },
  'Fires a homing bolt at the nearest enemy on a timer.': {
    es: 'Dispara periódicamente un perno teledirigido al enemigo más cercano.',
    fr: 'Tire périodiquement un carreau autoguidé sur l\'ennemi le plus proche.',
    ja: '一定間隔で最も近い敵に誘導ボルトを発射する。',
    ko: '일정 간격으로 가장 가까운 적에게 유도 볼트를 발사한다.',
  },
  'Nova Pulse': { es: 'Pulso Nova', fr: 'Pulsation Nova', ja: 'ノヴァパルス', ko: '노바 펄스' },
  'Periodically detonates a damaging ring centered on you.': {
    es: 'Detona periódicamente un anillo de daño centrado en ti.',
    fr: 'Déclenche périodiquement un anneau de dégâts centré sur vous.',
    ja: '一定間隔で自分を中心にダメージリングを起爆する。',
    ko: '일정 간격으로 자신을 중심으로 피해 고리를 폭발시킨다.',
  },
  'Piercing Lance': { es: 'Lanza Perforante', fr: 'Lance Perforante', ja: '貫通ランス', ko: '관통 랜스' },
  'Launches a straight lance that pierces every enemy in its path.': {
    es: 'Lanza una lanza recta que atraviesa a todos los enemigos en su trayectoria.',
    fr: 'Lance une lance rectiligne qui transperce tous les ennemis sur son passage.',
    ja: '直線状のランスを放ち、進路上の敵をすべて貫通する。',
    ko: '직선으로 랜스를 발사해 경로상의 모든 적을 관통한다.',
  },
  'Shot Spray': { es: 'Ráfaga de Perdigones', fr: 'Gerbe de Plombs', ja: 'ショットスプレー', ko: '샷 스프레이' },
  'Fans out a spread of short-range pellets at the nearest cluster.': {
    es: 'Dispara un abanico de perdigones de corto alcance hacia el grupo enemigo más cercano.',
    fr: 'Tire un éventail de plombs à courte portée sur le groupe ennemi le plus proche.',
    ja: '最も近い敵の集団に向けて近距離の散弾を扇状に放つ。',
    ko: '가장 가까운 적 무리를 향해 근거리 산탄을 부채꼴로 발사한다.',
  },
  'Static Aura': { es: 'Aura Estática', fr: 'Aura Statique', ja: 'スタティックオーラ', ko: '정전기 오라' },
  'A constant damage field that ticks on every enemy touching you.': {
    es: 'Un campo de daño constante que afecta a todo enemigo que te toque.',
    fr: 'Un champ de dégâts constant qui affecte tout ennemi vous touchant.',
    ja: '常時ダメージフィールドを展開し、触れた敵に継続ダメージを与える。',
    ko: '지속 피해 장을 형성해 접촉한 모든 적에게 피해를 준다.',
  },
  'Chain Spark': { es: 'Chispa en Cadena', fr: 'Étincelle en Chaîne', ja: 'チェインスパーク', ko: '체인 스파크' },
  'A bolt of electricity that arcs between nearby enemies.': {
    es: 'Un rayo eléctrico que salta entre los enemigos cercanos.',
    fr: 'Un éclair électrique qui bondit entre les ennemis proches.',
    ja: '近くの敵の間を渡る電撃。',
    ko: '주변 적들 사이를 연쇄적으로 튀는 전격.',
  },
  'Drop Mine': { es: 'Mina Trampa', fr: 'Mine Larguée', ja: 'ドロップマイン', ko: '드롭 마인' },
  'Drops a proximity mine behind you that explodes on contact.': {
    es: 'Coloca una mina de proximidad detrás de ti que explota al contacto.',
    fr: 'Dépose derrière vous une mine de proximité qui explose au contact.',
    ja: '背後に近接感知地雷を設置し、接触すると爆発する。',
    ko: '뒤쪽에 근접 감지 지뢰를 설치해 접촉 시 폭발시킨다.',
  },

  // --- passives (content.js PASSIVES) ---
  'Might': { es: 'Poder', fr: 'Puissance', ja: '筋力', ko: '힘' },
  '+dmg to all weapons.': { es: '+daño a todas las armas.', fr: '+dégâts pour toutes les armes.', ja: '全武器のダメージ上昇。', ko: '모든 무기의 피해량 증가.' },
  'Haste': { es: 'Celeridad', fr: 'Hâte', ja: '迅速', ko: '신속' },
  '+move speed.': { es: '+velocidad de movimiento.', fr: '+vitesse de déplacement.', ja: '移動速度上昇。', ko: '이동 속도 증가.' },
  'Focus': { es: 'Enfoque', fr: 'Concentration', ja: '集中', ko: '집중' },
  '-weapon cooldowns.': { es: '-tiempo de reutilización de armas.', fr: '-temps de recharge des armes.', ja: '武器のクールダウン短縮。', ko: '무기 재사용 대기시간 감소.' },
  'Vigor': { es: 'Vigor', fr: 'Vigueur', ja: '活力', ko: '활력' },
  '+max HP and regen.': { es: '+HP máx. y regeneración.', fr: '+PV max. et régénération.', ja: '最大HPと回復量上昇。', ko: '최대 체력 및 재생 증가.' },
  'Magnet': { es: 'Imán', fr: 'Aimant', ja: 'マグネット', ko: '자석' },
  '+XP pickup radius.': { es: '+radio de recogida de XP.', fr: '+rayon de collecte d\'XP.', ja: 'XP回収範囲上昇。', ko: 'XP 획득 반경 증가.' },
  'Armor': { es: 'Armadura', fr: 'Armure', ja: '装甲', ko: '방어구' },
  'Flat damage reduction.': { es: 'Reducción fija de daño recibido.', fr: 'Réduction fixe des dégâts subis.', ja: '被ダメージを一定量軽減する。', ko: '받는 피해를 고정값만큼 감소.' },
  'Growth': { es: 'Crecimiento', fr: 'Croissance', ja: '成長', ko: '성장' },
  '+XP gained from gems.': { es: '+XP obtenida de las gemas.', fr: '+XP obtenue des gemmes.', ja: 'ジェムから得られるXP上昇。', ko: '보석에서 얻는 XP 증가.' },
  'Amplitude': { es: 'Amplitud', fr: 'Amplitude', ja: '振幅', ko: '진폭' },
  '+area/size of all weapon effects.': {
    es: '+área/tamaño de todos los efectos de armas.',
    fr: '+zone/taille de tous les effets d\'armes.',
    ja: '全武器の効果範囲・サイズ上昇。',
    ko: '모든 무기 효과의 범위/크기 증가.',
  },

  // --- evolutions (content.js EVOLUTIONS) ---
  'Blade Storm': { es: 'Tormenta de Cuchillas', fr: 'Tempête de Lames', ja: 'ブレードストーム', ko: '블레이드 스톰' },
  'Doubles the blade ring and adds a knockback shockwave on every hit.': {
    es: 'Duplica el anillo de cuchillas y añade una onda de choque que empuja en cada golpe.',
    fr: 'Double l\'anneau de lames et ajoute une onde de choc repoussante à chaque coup.',
    ja: '刃のリングが倍増し、命中毎にノックバック衝撃波が発生する。',
    ko: '칼날 고리가 두 배로 늘고, 타격마다 넉백 충격파가 발생한다.',
  },
  'Railgun': { es: 'Cañón de Riel', fr: 'Canon Électromagnétique', ja: 'レールガン', ko: '레일건' },
  'Bolts become instant hitscan lines that pierce the whole map.': {
    es: 'Los pernos se convierten en líneas instantáneas que atraviesan todo el mapa.',
    fr: 'Les carreaux deviennent des lignes instantanées qui traversent toute la carte.',
    ja: 'ボルトが即着弾のライン攻撃となり、マップ全体を貫通する。',
    ko: '볼트가 즉시 명중하는 광선이 되어 맵 전체를 관통한다.',
  },
  'Heartstorm': { es: 'Tormenta del Corazón', fr: 'Tempête du Cœur', ja: 'ハートストーム', ko: '하트스톰' },
  'Nova pulses continuously at low power and heals you per enemy hit.': {
    es: 'La nova pulsa continuamente a baja potencia y te cura por cada enemigo golpeado.',
    fr: 'La nova pulse en continu à faible puissance et vous soigne à chaque ennemi touché.',
    ja: 'ノヴァが低出力で常時発動し、敵に命中するたび回復する。',
    ko: '노바가 낮은 출력으로 끊임없이 발동되며, 적을 맞출 때마다 체력을 회복한다.',
  },
  'Skewer': { es: 'Ensartador', fr: 'Embrocheur', ja: 'スキュワー', ko: '스큐어' },
  'Lance fires three parallel piercing beams instead of one.': {
    es: 'La lanza dispara tres rayos perforantes paralelos en lugar de uno.',
    fr: 'La lance tire trois faisceaux perforants parallèles au lieu d\'un seul.',
    ja: 'ランスが一本ではなく三本の平行な貫通ビームを放つ。',
    ko: '랜스가 하나 대신 세 갈래의 평행한 관통 광선을 발사한다.',
  },
  'Gravity Well': { es: 'Pozo de Gravedad', fr: 'Puits de Gravité', ja: 'グラビティウェル', ko: '중력 우물' },
  'Aura pulls enemies inward while damaging them, then quakes.': {
    es: 'El aura atrae a los enemigos hacia el centro mientras los daña, y luego provoca un temblor.',
    fr: 'L\'aura attire les ennemis vers le centre en les blessant, puis déclenche une secousse.',
    ja: 'オーラが敵にダメージを与えながら引き寄せ、その後震動を起こす。',
    ko: '오라가 적에게 피해를 주며 끌어당긴 뒤 진동을 일으킨다.',
  },
  'Storm Front': { es: 'Frente Tormentoso', fr: 'Front Orageux', ja: 'ストームフロント', ko: '스톰 프런트' },
  'Chain spark jumps infinitely and grants bonus XP per arc.': {
    es: 'La chispa en cadena salta sin límite y otorga XP extra por cada arco.',
    fr: 'L\'étincelle en chaîne bondit sans limite et octroie de l\'XP bonus par arc.',
    ja: '連鎖火花が無限に跳躍し、跳躍毎にボーナスXPを得る。',
    ko: '체인 스파크가 무한히 튀며, 튈 때마다 추가 XP를 얻는다.',
  },

  // --- enemies + boss (content.js ENEMIES, BOSS) ---
  'Chaser': { es: 'Perseguidor', fr: 'Poursuivant', ja: 'チェイサー', ko: '추격자' },
  'Swarmer': { es: 'Enjambrador', fr: 'Essaimeur', ja: 'スウォーマー', ko: '무리체' },
  'Charger': { es: 'Embestidor', fr: 'Chargeur', ja: 'チャージャー', ko: '돌진체' },
  'Splitter': { es: 'Divisor', fr: 'Diviseur', ja: 'スプリッター', ko: '분열체' },
  'Shielded': { es: 'Blindado', fr: 'Blindé', ja: 'シールド持ち', ko: '방패체' },
  'Ranged': { es: 'Tirador', fr: 'Tireur', ja: '射撃兵', ko: '원거리체' },
  'Elite': { es: 'Élite', fr: 'Élite', ja: 'エリート', ko: '엘리트' },
  'The Swarm Mother': { es: 'La Madre del Enjambre', fr: "La Mère de l'Essaim", ja: 'スウォームマザー', ko: '스웜 마더' },

  // --- characters (content.js CHARACTERS) ---
  'Wren': { es: 'Wren', fr: 'Wren', ja: 'レン', ko: '렌' },
  'Balanced starter. Opens with the Whirling Blade.': {
    es: 'Inicial equilibrado. Comienza con la Cuchilla Giratoria.',
    fr: 'Débutant équilibré. Commence avec la Lame Tournoyante.',
    ja: 'バランス型の初期キャラ。回転ブレードを装備して出撃。',
    ko: '균형 잡힌 초보자. 선풍의 칼날로 시작한다.',
  },
  'Kestrel': { es: 'Kestrel', fr: 'Kestrel', ja: 'ケストレル', ko: '케스트럴' },
  'Fast and fragile. Opens with Auto Bolt, +15% speed, -15% max HP.': {
    es: 'Rápida y frágil. Comienza con Perno Automático, +15% velocidad, -15% HP máx.',
    fr: 'Rapide et fragile. Commence avec le Carreau Automatique, +15% vitesse, -15% PV max.',
    ja: '素早いが脆い。オートボルトを装備、速度+15%、最大HP-15%。',
    ko: '빠르지만 약함. 오토 볼트로 시작, 속도 +15%, 최대 체력 -15%.',
  },
  'Thorn': { es: 'Thorn', fr: 'Thorn', ja: 'ソーン', ko: '쏜' },
  'Tanky brawler. Opens with Static Aura, +25% max HP, -10% speed.': {
    es: 'Luchador resistente. Comienza con Aura Estática, +25% HP máx., -10% velocidad.',
    fr: 'Bagarreur robuste. Commence avec l\'Aura Statique, +25% PV max., -10% vitesse.',
    ja: '頑丈な近接型。スタティックオーラを装備、最大HP+25%、速度-10%。',
    ko: '튼튼한 근접형. 정전기 오라로 시작, 최대 체력 +25%, 속도 -10%.',
  },
  'Vane': { es: 'Vane', fr: 'Vane', ja: 'ヴェイン', ko: '베인' },
  'Glass cannon. Opens with Lance, +20% damage, -20% max HP.': {
    es: 'Cañón de cristal. Comienza con la Lanza, +20% daño, -20% HP máx.',
    fr: 'Canon de verre. Commence avec la Lance, +20% dégâts, -20% PV max.',
    ja: 'グラスキャノン型。ランスを装備、ダメージ+20%、最大HP-20%。',
    ko: '유리 대포형. 랜스로 시작, 피해 +20%, 최대 체력 -20%.',
  },
  'Coil': { es: 'Coil', fr: 'Coil', ja: 'コイル', ko: '코일' },
  'Crowd control specialist. Opens with Chain Lightning, +12% max HP, -8% speed.': {
    es: 'Especialista en control de masas. Comienza con Relámpago en Cadena, +12% HP máx., -8% velocidad.',
    fr: 'Spécialiste du contrôle de foule. Commence avec l\'Éclair en Chaîne, +12% PV max., -8% vitesse.',
    ja: '群衆制御の専門家。連鎖稲妻を装備、最大HP+12%、速度-8%。',
    ko: '군중 제어 전문가. 연쇄 번개로 시작, 최대 체력 +12%, 속도 -8%.',
  },
});
