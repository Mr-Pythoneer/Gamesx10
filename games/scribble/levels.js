...
export const LEVELS = [
  ...
  {
    name: 'Slot Machine',
    hint: 'Too slow and you drop short. Too fast and you sail over. Tune the ramp.',
    ink: 520,
    par: 300,
    ball: { x: 60, y: 90 },
    goal: { x: 765, y: 436, r: 50 },
    walls: [
      WALL_L, WALL_R,
      [0, 140, 200, 190],
      [200, 300, 500, 300],
...
const SOLUTIONS = {
  0: { strokes: [{ tool: 'static', points: [[30, 240], [600, 470]] }] },
  1: { strokes: [{ tool: 'static', points: [[300, 376], [640, 424]] }] },
  2: { strokes: [{ tool: 'static', points: [[240, 348], [706, 388]] }] },
  3: { strokes: [{ tool: 'static', points: [[220, 230], [400, 424]] }] },
  4: { strokes: [{ tool: 'static', points: [[320, 240], [720, 430]] }] },
  5: { strokes: [{ tool: 'static', points: [[220, 194], [520, 330]] }] },
  6: { strokes: [{ tool: 'static', points: [[220, 348], [706, 396]] }] },
  7: { strokes: [{ tool: 'static', points: [[200, 304], [470, 300]] }] },
  8: {
    strokes: [
  ...
  10: { strokes: [{ tool: 'static', points: [[330, 470], [430, 500]] }] },
  11: {
    strokes: [
